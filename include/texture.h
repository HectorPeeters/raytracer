...
void texture_data_set(struct texture_t *texture, u16 x, u16 y, u8 r, u8 g,
                      u8 b);
void texture_data_set(struct texture_t *texture, u16 x, u16 y, u8 r, u8 g, u8 b,
                      u8 a);

void texture_data_destroy(struct texture_t *texture);
